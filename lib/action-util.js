        ...
        return getAllSyncData(harvestSource, harvestDest, syncs)
            .then((syncsData) => {
                ...
                syncsData.forEach((sync) => {
                    allPromises.push(getSingleSyncActions(harvestSource, harvestDest, sync, startDate))
                })
...
function getSingleSyncActions(harvestSource, harvestDest, syncsData, startDate) {
    return new Promise((resolve, reject) => {
        let allPromises = []
